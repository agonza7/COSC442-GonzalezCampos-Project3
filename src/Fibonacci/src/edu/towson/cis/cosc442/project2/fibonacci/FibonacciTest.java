...
public class FibonacciTest {
	...
	public void testFibonacci() {	
		...
		assertEquals("8", 21, fibonacci.fibonacci(8));
		assertEquals("9", 34, fibonacci.fibonacci(9));
		assertEquals("10", 55, fibonacci.fibonacci(10));
		assertEquals("17", 1597, fibonacci.fibonacci(17));
	}
}
